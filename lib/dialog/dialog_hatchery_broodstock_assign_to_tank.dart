...
class DialogHatcheryBroodstockAssignToTank extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    //Data data = InheritedProvider.of()
    // TODO: implement createState
    return new DialogHatcheryBroodstockAssignToTankState();
  }
}
class DialogHatcheryBroodstockAssignToTankState extends State<DialogHatcheryBroodstockAssignToTank> {
  ...
  _broodstockAssignToTank(BuildContext context) async {
    ...
    if(txtMale.text.toString().length != 0 && txtFemale.text.toString().length != 0 &&
      ...
      if(male <= curMale && female <= curFemale && male > 0 && female > 0){
        http.Response response = await http.post(
            ...
            body: utf8.encode(Broodstock.queryAssignToTankBroodstock(
                idBatch, female, male, date, idTank, idStaff, idHatchery, "termination")),
            encoding: Encoding.getByName("UTF-8")
        );
        var p = response.body.indexOf(">");
        var e = response.body.lastIndexOf("<");
        ...
        child: FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if (snapshot.hasError) {
              ...
              curMale = int.parse(contract.att8);
              curFemale = int.parse(contract.att9);
              return Column(
                children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Material(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: (){
                              _broodstockAssignToTank(context);
                            },
