...
class BroodstockContractSell extends StatefulWidget {

  @override
  State<StatefulWidget> createState() {
    //Data data = InheritedProvider.of()
    // TODO: implement createState
    return new BroodstockContractSellState();
  }
}
class BroodstockContractSellState extends State<BroodstockContractSell> {

  String idCon, idTransport;

  AsyncMemoizer<Data> memCache = AsyncMemoizer();
  Future<Data> _getInfoBroodstockContractSell(String idCon) async{
    return memCache.runOnce(() async {
      http.Response response = await http.post(
          ...
          body: utf8.encode(Contract.queryGetInfoOfBroodstockContractSell(idCon)),
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      body: SingleChildScrollView(
          child: FutureBuilder(
              future: _getInfoBroodstockContractSell(idCon),
              builder: (BuildContext context, AsyncSnapshot snapshot){
                if(snapshot.hasError){
                  ...
                  String moneyTransferDate = function.convertDateCSDLToDateDefault('${contract.att7}');
                  ...
                  return new Column(
                    children: <Widget>[
                      ...
                      Card(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            ViewsWidget.buildRowDetails(context, 'number_of_pair', '${function.formatNumber(contract.att12)}'),
                      ...
                      Card(
                        ...
                        child: Column(
                          children: <Widget>[
                            ViewsWidget.buildRowDetails(context, 'via_bank', '${contract.att8}'),
                            ViewsWidget.buildRowDetails(context, 'wiring_number', '${contract.att9}'),
                          ],
                        ),
                      ),
                      Card(
                        ...
                        child: Column(
                          children: <Widget>[
                            ViewsWidget.buildRowDetails(context,'total_amount', '${function.formatNumber(contract.att10)}'),
                            ViewsWidget.buildRowDetails(context,'transfer_amount', '${function.formatNumber(contract.att11)}'),
                          ],
                        ),
                      ),
