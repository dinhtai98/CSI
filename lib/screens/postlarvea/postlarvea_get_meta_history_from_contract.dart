...
class PostlarveaMetaHistoryFromContract extends StatefulWidget {

  @override
  State<StatefulWidget> createState() {
    //Data data = InheritedProvider.of()
    // TODO: implement createState
    return new PostlarveaMetaHistoryFromContractState();
  }
}
class PostlarveaMetaHistoryFromContractState extends State<PostlarveaMetaHistoryFromContract> {
  String idCon;
  ...
  Future<Data> _getInfoSubBatchNaupliiFromPostlarveaContract(String idCon) async{
    return memCache.runOnce(() async {
      ...
      while(i++ < 3) {
        http.Response response = await http.post(
            ...
            body: utf8.encode(
                Postlarvea.queryGetOriginalNumNaupliiFromPostContract(idCon)),
  ...
  Future<Map<String, Data>> _getPostMetaHistoryFromContract(String idCon) async{
    return memCacheStages.runOnce(() async {
      ...
      while(i++ < 3) {
        ...
        http.Response response = await http.post(
            ...
            body: utf8.encode(Postlarvea.queryGetHistoryOfPostLarveaFromPostlarveaContract(idCon)),
            encoding: Encoding.getByName("UTF-8")
        );
        Data data = new Data();
        var p = response.body.indexOf("[");
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        ...
        body: SingleChildScrollView(
            child: FutureBuilder(
                future:_getInfoSubBatchNaupliiFromPostlarveaContract(idCon),
                    ...
                    return new Column(
                      children: <Widget>[
                        ...
                        Card(
                            ...
                            margin: new EdgeInsets.symmetric(horizontal: 5.0, vertical: 6.0),
                            child: FutureBuilder(
                                future:_getPostMetaHistoryFromContract(idCon),
