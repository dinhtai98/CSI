...
class DARDQuarantine extends StatefulWidget {

  @override
  State<StatefulWidget> createState() {
    //Data data = InheritedProvider.of()
    // TODO: implement createState
    return new DARDQuarantineState();
  }
}
class DARDQuarantineState extends State<DARDQuarantine> {

  Future<Data> _getInfoDARDQuarantine(String idCon) async{
    http.Response response = await http.post(
        ...
        body: utf8.encode(Contract.queryGetInfoOfDARDQuarantine(idCon)),
        encoding: Encoding.getByName("UTF-8")
    );
    print("process DARD quarantine");
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: Text(Translations.of(context).text('title_dard_quarantine')
      ...
      body: SingleChildScrollView(
          child: FutureBuilder(
              future: _getInfoDARDQuarantine(idCon),
                  ...
                  return Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        ViewsWidget.buildRowDetails(context, 'date', '${function.convertDateCSDLToDateTimeDefault(contract.att3.toString())}'),
                      ],
                    ),
                  );
                }
