...
class AdminHatcheryDetails extends StatefulWidget {

  @override
  State<StatefulWidget> createState() {
    //Data data = InheritedProvider.of()
    // TODO: implement createState
    return new AdminHatcheryDetailsState();
  }
}
class AdminHatcheryDetailsState extends State<AdminHatcheryDetails> {
  String idHatchery;
                      ...
                      Card(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            ViewsWidget.buildRowDetails(context, 'establish_year', '${function.convertTimeStampCSDLToYear(hatchery.att8)}'),
                          ],
                        ),
                      ),
                    ],
