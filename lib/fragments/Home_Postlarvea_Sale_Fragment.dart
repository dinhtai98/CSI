...
import 'package:flutter_helloworld/screens/postlarvea/detail_contract_buy.dart';
import 'package:flutter_helloworld/screens/postlarvea/detail_postlarvea_contract_sell.dart';
...
class HomePostlarveaSaleFragment extends StatefulWidget {
  //final data = InheritedProvider.of<Data>(context);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new HomePostlarveaSaleFragmentState();
  }
}
class HomePostlarveaSaleFragmentState extends State<HomePostlarveaSaleFragment> {
  int _radio = 1;
  int oldRadio = 1;
  ...
  Future<List<dynamic>> _getAllPostlarveaContractOfHatchery(String idHatchery, int type, String date) async{
    ...
    return memCache.runOnce(() async {
      http.Response response = await http.post(
          ...
          Postlarvea.queryGetAllPostlarveaContractBuyOfHatchery(idHatchery,date) :
          Postlarvea.queryGetAllPostlarveaContractSellOfHatchery(idHatchery,date)),
          ...
          child: ScopedModelDescendant<PopupMenu>(
            builder: (context, child, model) {
              ...
              return FutureBuilder(
                  future: _getAllPostlarveaContractOfHatchery(data.att1,_radio,model.selectedDate),
              ...
              Navigator.of(context).push(new MaterialPageRoute<Null>(
                  builder: (_) =>
                      InheritedProvider<String>(
                        child: _radio == 1 ? new PostlarveaContractBuy() : new PostlarveaContractSell() ,
